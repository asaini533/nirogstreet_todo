...
const create = (entity, value, name, changeDependency) => {
  ...
  return async () => {
    ...
    lib.whenResult(
      (createdEntity) => (R.head(data)[name].created_by_factory = true)
    )(result[0]);
    lib.whenResult(lib.doNothing, (e) => console.trace(entity.name, e))(
      result[0]
    );
...
const createSingle = (entity, value, changeDependency) =>
  R.composeP(
    getEntity,
    R.head,
    addToCache,
