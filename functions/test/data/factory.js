...
const loadFactory = async () => {
  factory.define("user", Object, {
    ...
    mobile: factory.chance("phone", { mobile: true, formatted: false }),
    gender: factory.chance("gender"),
    country: factory.chance("country"),
    hobby: factory.chance("string"),
    email: factory.chance("email"),
    password: factory.chance("string"),
  });

  factory.define("todo", Object, {
    id: factory.chance("guid"),
    name: factory.chance("name"),
    description: factory.chance("paragraph", { sentences: 1 }),
